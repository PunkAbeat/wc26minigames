...
| QA-listen: Iran + Paraguay (`Removed/` recordings), DR Congo verification | done | owner verified all three 11 Jun; DR Congo wired as 46th nation; Qatar/Jordan soft-open check outstanding ([research/qa-listen.md](../research/qa-listen.md)) |
