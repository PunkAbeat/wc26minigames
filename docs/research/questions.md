...
6. **Game #2 selection.** Brainstorm in progress with the owner — candidates, criteria and viral-mechanics research live in [game2-brainstorm.md](game2-brainstorm.md). Flagship directions after two rounds: **TOP BINS** (daily penalty vs. the crowd — minority game on existing counters), **GROUPS** (Connections-style nation wall), **BRACKET** (daily-seeded 2048 mapped to the knockout bracket). Owner picks.
