...
6. **Game #2 selection.** Brainstorm in progress with the owner — candidates, criteria and viral-mechanics research live in [game2-brainstorm.md](game2-brainstorm.md). Owner constraint (12 Jun): **no crowd-powered mechanics yet** (no traffic) — TOP BINS / RARE PICK parked as flywheel games for later. Live finalists: **GROUPS** (Connections-style nation wall, widest appeal, needs editorial pipeline) vs **BRACKET** (daily-seeded 2048 mapped to the knockout bracket, zero daily content cost). Owner picks.
